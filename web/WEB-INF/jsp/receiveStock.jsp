...
<head>
    ...
    <title>Receive Stock - Stock Management System</title>
    <style>
        /* Same CSS as above */
        body {
...
<li><a href="receive_stock.jsp">Stock Management</a></li>
<!--                <li><a href="receive_stock.jsp">Receive Stock</a></li>-->
    ...
    <main>
        <h1>Receive Stock</h1>
        <p>Record incoming stock here.</p>
        <form action="process_receive_stock.jsp" method="post">
