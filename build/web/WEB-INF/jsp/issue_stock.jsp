...
<head>
    ...
    <title>Issue Stock - Stock Management System</title>
    <style>
        /* General Styles */
        body {
...
<body>
    ...
    <main>
        <h1>Issue Stock</h1>
        <p>Record outgoing stock here.</p>
        <form action="process_issue_stock.jsp" method="post">
            ...
            <label for="stockQuantity">Quantity Issued:</label>
